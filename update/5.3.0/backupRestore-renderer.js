...
async function onSave (reason, toSave, index, length) {
    ...
    if (toSave[index] === true) {
        ...
        if (result === true) {
            ...
            if (index === 2 && reason === 'backup')  document.getElementById('backup-node-img').src = "../images/icons/done.png";
            if (index === 3 && reason === 'backup')  document.getElementById('backup-github-img').src = "../images/icons/done.png";
            if (index === 4 && reason === 'backup')  document.getElementById('backup-plugin-img').src = "../images/icons/done.png";
            ...
            if (index === 2 && reason === 'restore')  document.getElementById('restore-node-img').src = "../images/icons/done.png";
            if (index === 3 && reason === 'restore')  document.getElementById('restore-github-img').src = "../images/icons/done.png";
            if (index === 4 && reason === 'restore')  document.getElementById('restore-plugin-img').src = "../images/icons/done.png";
            ...
            if (index === 2 && reason === 'default')  document.getElementById('delete-node-img').src = "../images/icons/done.png";
            if (index === 3 && reason === 'default')  document.getElementById('delete-github-img').src = "../images/icons/done.png";
            ...
            if (index === 2 && reason === 'restore')  document.getElementById('restore-node-img').src = "../images/icons/notRestore.png";
            if (index === 3 && reason === 'restore')  document.getElementById('restore-github-img').src = "../images/icons/notRestore.png";
            if (index === 4 && reason === 'restore')  document.getElementById('restore-plugin-img').src = "../images/icons/notRestore.png";
            onSave (reason, toSave, ++index, length);
        } else {
            let msg;
            if (reason === 'backup')  
...
document.getElementById("backup").addEventListener("click", async (event) => {
    ...
    document.getElementById('backup-node-img').src = "../images/icons/notdone.png";
    document.getElementById('backup-github-img').src = "../images/icons/notdone.png";
...
document.getElementById("delete").addEventListener("click", async (event) => {
    ...
    document.getElementById('delete-node-img').src = "../images/icons/notdone.png";
    document.getElementById('delete-github-img').src = "../images/icons/notdone.png";
...
document.getElementById("restore").addEventListener("click", async (event) => {
    ...
    document.getElementById('restore-node-img').src = "../images/icons/notdone.png";
    document.getElementById('restore-github-img').src = "../images/icons/notdone.png";
...
function setLangTargets() {
    return new Promise(async (resolve) => {
      ...
      document.getElementById('backup-node-label').innerHTML = await Lget("backupRestore", "backupNodesLabel");
      document.getElementById('backup-github-label').innerHTML = await Lget("backupRestore", "backupGithubLabel");
      ...
      document.getElementById('restore-node-label').innerHTML = await Lget("backupRestore", "restoreNodesLabel");
      document.getElementById('restore-github-label').innerHTML = await Lget("backupRestore", "restoreGithubLabel");
      ...
      document.getElementById('delete-node-label').innerHTML = await Lget("backupRestore", "deleteNodesLabel");
      document.getElementById('delete-github-label').innerHTML = await Lget("backupRestore", "deleteGithubLabel");
