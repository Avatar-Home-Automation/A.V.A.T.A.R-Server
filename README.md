...
* Windows (Windows 10 and up): `ia32 (x86)`, `x64 (amd64)`, `arm64` ![Static Badge](https://img.shields.io/badge/release-100%25_ok-brightgreen?style=plastic)
* Mac0S (Big Sur and up): `64-bit Intel` and `Apple Silicon / ARM binaries` for macOS.	![Static Badge](https://img.shields.io/badge/release-90%25-orange)
* Linux (Ubuntu 18.04 and newer, Fedora 32 and newer, Debian 10 and newer): `x64 (amd64)`, `arm64` ![Static Badge](https://img.shields.io/badge/release-100%25_ok-brightgreen?style=plastic)
* Raspberry Pi (Raspberry Pi OS): `arm64`. Server only, no voices and voice regognition for clients  ![Static Badge](https://img.shields.io/badge/release-100%25_ok-brightgreen?style=plastic)
